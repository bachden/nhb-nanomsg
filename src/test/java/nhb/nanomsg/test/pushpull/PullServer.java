package nhb.nanomsg.test.pushpull;

import java.nio.ByteBuffer;
import java.util.concurrent.CountDownLatch;

import nhb.nanomsg.NNReceiver;
import nhb.nanomsg.NNSocket;
import nhb.nanomsg.NNSockets;
...
public class PullServer extends NNReceiver {
	...
	protected void onStartSuccess() {
		System.out.println("Pull server started, waiting for message...");
